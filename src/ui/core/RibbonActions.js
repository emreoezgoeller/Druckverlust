...
import DeploymentDiagnostics from '../../diagnostics/DeploymentDiagnostics.js?v=42.00&release=45.00';
...
import { APP_ASSET_VERSION, APP_BUILD_LABEL, APP_RELEASE, createAppInfo } from '../../core/appVersion.js?v=42.00&release=45.00';
import { createLicenseStatus, formatLicenseStatusText } from '../../licensing/licenseConfig.js';
import UiDialogService from './UiDialogService.js?v=42.00&release=45.00';
