...
import ProjectCalculationService from '../project/ProjectCalculationService.js?v=58.20';
import ProjectDiagnostics from './ProjectDiagnostics.js?v=58.20';
import CalculationDiagnostics from './CalculationDiagnostics.js?v=58.20';
import DeploymentDiagnostics from './DeploymentDiagnostics.js?v=58.20';
import ProjectFileDiagnostics from './ProjectFileDiagnostics.js?v=58.20';
import ReleaseIntegrityDiagnostics from './ReleaseIntegrityDiagnostics.js?v=58.20';
import ReportEngine from '../report/ReportEngine.js?v=58.20';
import createDemoProject from '../project/demoProject.js?v=58.20';
import { createSmallOfficePracticeProject } from '../project/officePracticeProjects.js?v=58.20';
import StorageEngine, { PROJECT_FILE_SCHEMA_VERSION } from '../storage/StorageEngine.js?v=58.20';
import {
  APP_ASSET_VERSION,
  APP_RELEASE,
  APP_VERSION,
