...
import ProjectCalculationService from '../project/ProjectCalculationService.js?v=58.40';
import ProjectDiagnostics from './ProjectDiagnostics.js?v=58.40';
import CalculationDiagnostics from './CalculationDiagnostics.js?v=58.40';
import DeploymentDiagnostics from './DeploymentDiagnostics.js?v=58.40';
import ProjectFileDiagnostics from './ProjectFileDiagnostics.js?v=58.40';
import ReleaseIntegrityDiagnostics from './ReleaseIntegrityDiagnostics.js?v=58.40';
import ReportEngine from '../report/ReportEngine.js?v=58.40';
import createDemoProject from '../project/demoProject.js?v=58.40';
import { createSmallOfficePracticeProject } from '../project/officePracticeProjects.js?v=58.40';
import StorageEngine, { PROJECT_FILE_SCHEMA_VERSION } from '../storage/StorageEngine.js?v=58.40';
import {
  APP_ASSET_VERSION,
  APP_RELEASE,
  APP_VERSION,
  APP_BUILD_LABEL,
} from '../core/appVersion.js?v=58.40';
