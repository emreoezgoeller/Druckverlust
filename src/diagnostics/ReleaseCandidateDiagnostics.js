...
import DeploymentDiagnostics from './DeploymentDiagnostics.js?v=31.00';
...
import { APP_ASSET_VERSION, APP_RELEASE, APP_BUILD_LABEL } from '../core/appVersion.js?v=31.00';
