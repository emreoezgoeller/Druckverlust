...
import DeploymentDiagnostics from './DeploymentDiagnostics.js?v=32.00';
...
import { APP_ASSET_VERSION, APP_RELEASE, APP_BUILD_LABEL } from '../core/appVersion.js?v=32.00';
...
export default class ReleaseCandidateDiagnostics {
  static async run({ state = null, project = null, system = null, registry = null, includeDeployment = true } = {}) {
    ...
    try {
      const result = ProjectCalculationService.calculate(activeProject);
