...
import ApplicationShell from './ui/ApplicationShell.js?v=22.04';
import RibbonComponent from './ui/components/RibbonComponent.js?v=22.04';
import SidebarComponent from './ui/components/SidebarComponent.js?v=22.04';
import WorkspaceComponent from './ui/components/WorkspaceComponent.js?v=22.04';
...
import { APP_RELEASE, APP_BUILD_LABEL, createAppInfo } from './core/appVersion.js?v=22.04';
