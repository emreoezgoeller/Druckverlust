...
import ApplicationShell from './ui/ApplicationShell.js?v=51.20&release=51.20';
import RibbonComponent from './ui/components/RibbonComponent.js?v=51.20&release=51.20';
import SidebarComponent from './ui/components/SidebarComponent.js?v=51.20&release=51.20';
import WorkspaceComponent from './ui/components/WorkspaceComponent.js?v=51.20&release=51.20';
import StatusBarComponent from './ui/components/StatusBarComponent.js?v=51.20&release=51.20';
...
import KeyboardShortcuts from './ui/core/KeyboardShortcuts.js?v=51.20&release=51.20';
import AutoSaveEngine from './storage/AutoSaveEngine.js';
import { APP_RELEASE, APP_BUILD_LABEL, createAppInfo } from './core/appVersion.js?v=51.20&release=51.20';
import UiTooltipController from './ui/core/UiTooltipController.js?v=51.20&release=51.20';
import ProjectHistoryEngine from './project/ProjectHistoryEngine.js?v=51.20&release=51.20';
