...
check(html.includes('src/main.js?v=45.00'), 'App lädt Main mit Phase-41-Cache-Stand.');
...
check(version.includes("APP_RELEASE = '45.00'"), 'Release ist Phase 41.00.');
check(version.includes("APP_VERSION = '2.0.0'"), 'App-Version ist 1.18.0.');
check(packageJson.version === '2.0.0', 'Paketversion ist 1.18.0.');
check(packageJson.scripts['test:phase41']?.includes('run-phase41-help-center-tests.js'), 'Phase-41-Testskript ist registriert.');
check(packageJson.scripts.test.startsWith('node tests/run-phase45-release-integration-tests.js'), 'Gesamttest startet mit der aktuellen Phase.');
