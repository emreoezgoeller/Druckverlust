...
match(appHtml, /phase31_00\.css\?v=35\.00/, 'Phase-31-CSS wird geladen.');
...
match(version, /APP_VERSION = '1\.12\.0'/, 'App-Version wurde auf 1.12.0 fortgeschrieben.');
match(version, /APP_RELEASE = '35\.00'/, 'Aktueller Release ist Phase 35.00.');
