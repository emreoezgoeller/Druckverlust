...
const checks = [
  ...
  [appHtml.includes('src/main.js?v=41.00'), 'Main-Modul verwendet den aktuellen Cache-Stand.'],
  [main.includes('RibbonComponent.js?v=41.00'), 'RibbonComponent wird cache-sicher geladen.'],
