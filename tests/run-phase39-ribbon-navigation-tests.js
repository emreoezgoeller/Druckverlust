...
const checks = [
  ...
  [appHtml.includes('src/main.js?v=39.03'), 'Main-Modul verwendet Cache-Version 39.03.'],
  [main.includes('RibbonComponent.js?v=39.03'), 'RibbonComponent wird cache-sicher geladen.'],
