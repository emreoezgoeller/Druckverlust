...
const checks = [
  ...
  [appHtml.includes('src/main.js?v=51.10'), 'Main-Modul verwendet den aktuellen Cache-Stand.'],
  [main.includes('RibbonComponent.js?v=51.10'), 'RibbonComponent wird cache-sicher geladen.'],
