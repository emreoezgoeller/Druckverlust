...
const expectations = [
  ...
  [files.app.includes('src/main.js?v=41.00'), 'Main-Modul verwendet Cache-Version 39.03.'],
  ...
  [files.version.includes("APP_RELEASE = '41.00'"), 'Release ist 39.00.'],
  [files.version.includes("APP_VERSION = '1.18.0'"), 'App-Version ist 1.16.0.'],
