...
const expectations = [
  [files.app.includes('phase32_00.css?v=32.00'), 'Phase-32-CSS ist eingebunden.'],
  [files.app.includes('src/main.js?v=32.00'), 'Main-Modul verwendet Cache-Version 32.00.'],
  ...
  [files.version.includes("APP_RELEASE = '32.00'"), 'Release ist 32.00.'],
  [files.version.includes("APP_VERSION = '1.9.0'"), 'App-Version ist 1.9.0.'],
