...
const expectations = [
  ...
  [files.app.includes('src/main.js?v=51.00'), 'Main-Modul verwendet Cache-Version 39.03.'],
  ...
  [files.version.includes("APP_RELEASE = '51.00'"), 'Release ist 39.00.'],
  [files.version.includes("APP_VERSION = '2.6.0'"), 'App-Version ist 1.16.0.'],
