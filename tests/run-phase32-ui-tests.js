...
const expectations = [
  [files.app.includes('phase32_00.css?v=35.00'), 'Phase-32-CSS ist eingebunden.'],
  [files.app.includes('src/main.js?v=35.00'), 'Main-Modul verwendet Cache-Version 35.00.'],
  ...
  [files.version.includes("APP_RELEASE = '35.00'"), 'Release ist 35.00.'],
  [files.version.includes("APP_VERSION = '1.12.0'"), 'App-Version ist 1.12.0.'],
