...
const expectations = [
  ...
  [files.app.includes('src/main.js?v=51.20'), 'Main-Modul verwendet Cache-Version 39.03.'],
  ...
  [files.version.includes("APP_RELEASE = '51.20'"), 'Release ist 39.00.'],
  [files.version.includes("APP_VERSION = '2.6.2'"), 'App-Version ist 1.16.0.'],
