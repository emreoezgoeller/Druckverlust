...
check(appHtml.includes('phase52_00.css?v=52.00&release=52.00'), 'Phase-52-Stylesheet wird cache-sicher geladen.');
check(appHtml.includes('src/main.js?v=52.00&release=52.00'), 'Main-Modul wird mit Phase-52-Kennung geladen.');
check(main.includes('WorkspaceComponent.js?v=52.00&release=52.00'), 'Workspace wird cache-sicher geladen.');
check(version.includes("APP_VERSION = '2.7.0'"), 'App-Version steht auf 2.7.0.');
check(version.includes("APP_RELEASE = '52.00'"), 'Release steht auf Phase 52.00.');
equal(packageJson.version, '2.7.0', 'package.json steht auf Version 2.7.0.');
equal(release.version, '2.7.0', 'release.json steht auf Version 2.7.0.');
equal(release.phase, '52.00', 'release.json steht auf Phase 52.00.');
