...
check(html.includes('phase40_00.css?v=40.00'), 'App lädt das neue Phase-40-Stylesheet.');
check(html.includes('src/main.js?v=41.00'), 'App lädt Main mit neuem Cache-Stand.');
check(packageJson.version === '1.18.0', 'Paketversion wurde auf 1.18.0 erhöht.');
