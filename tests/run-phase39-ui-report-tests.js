...
assert.match(appHtml, /phase39_00\.css\?v=58\.00/); checks += 1;
assert.match(appHtml, /src\/main\.js\?v=58\.00/); checks += 1;
assert.match(appHtml, /ApplicationShell\.css\?v=58\.00/); checks += 1;
...
assert.match(version, /APP_ASSET_VERSION = '58\.00'/); checks += 1;
