...
assert.match(appHtml, /phase39_00\.css\?v=57\.00/); checks += 1;
assert.match(appHtml, /src\/main\.js\?v=57\.00/); checks += 1;
assert.match(appHtml, /ApplicationShell\.css\?v=57\.00/); checks += 1;
...
assert.match(version, /APP_ASSET_VERSION = '57\.00'/); checks += 1;
