...
check(main.includes("UiTooltipController from './ui/core/UiTooltipController.js?v=51.10&release=51.10'"), 'Tooltip-Controller wird nicht cache-sicher geladen.');
...
// Release-Integration
check(appHtml.includes('phase51_00.css?v=51.00&release=51.10'), 'Phase-51-Stylesheet wird nicht geladen.');
check(appHtml.includes('src/main.js?v=51.10'), 'Anwendung lädt nicht den Phase-51-Cache-Stand.');
check(version.includes("APP_VERSION = '2.6.1'") && version.includes("APP_RELEASE = '51.10'"), 'Versionsdaten stehen nicht auf 2.6.1 / Phase 51.10.');
check(packageJson.version === '2.6.1', 'package.json steht nicht auf Version 2.6.1.');
check(release.version === '2.6.1' && release.phase === '51.10', 'release.json steht nicht auf Version 2.6.1 / Phase 51.10.');
