...
check(main.includes("UiTooltipController from './ui/core/UiTooltipController.js?v=58.00'"), 'Tooltip-Controller wird nicht cache-sicher geladen.');
...
// Release-Integration
check(appHtml.includes('phase51_00.css?v=58.00'), 'Phase-51-Stylesheet wird nicht geladen.');
check(appHtml.includes('src/main.js?v=58.00'), 'Anwendung lädt nicht den Phase-51-Cache-Stand.');
check(version.includes("APP_VERSION = '3.0.0'") && version.includes("APP_RELEASE = '58.00'"), 'Versionsdaten stehen nicht auf 2.7.0 / Phase 51.20.');
check(packageJson.version === '3.0.0', 'package.json steht nicht auf Version 2.7.0.');
check(release.version === '3.0.0' && release.phase === '58.00', 'release.json steht nicht auf Version 2.7.0 / Phase 51.20.');
