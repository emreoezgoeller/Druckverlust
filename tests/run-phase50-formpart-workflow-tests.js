...
check(appHtml.includes('phase50_00.css?v=50.00&release=53.00'), 'Phase-50-Stylesheet wird cache-sicher geladen.');
...
check(version.includes("APP_VERSION = '2.8.0'") && version.includes("APP_RELEASE = '53.00'"), 'Versionsdaten stehen auf dem aktuellen Release 2.7.0 / Phase 51.20.');
