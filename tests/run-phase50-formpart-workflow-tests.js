...
check(appHtml.includes('phase50_00.css?v=50.00&release=50.00'), 'Phase-50-Stylesheet wird cache-sicher geladen.');
...
check(version.includes("APP_VERSION = '2.5.0'") && version.includes("APP_RELEASE = '50.00'"), 'Versionsdaten stehen auf 2.5.0 / Phase 50.00.');
