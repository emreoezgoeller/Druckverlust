...
check(appHtml.includes('phase50_00.css?v=50.00&release=51.20'), 'Phase-50-Stylesheet wird cache-sicher geladen.');
...
check(version.includes("APP_VERSION = '2.6.2'") && version.includes("APP_RELEASE = '51.20'"), 'Versionsdaten stehen auf dem aktuellen Release 2.6.2 / Phase 51.20.');
