...
includes(appHtml, 'phase52_00.css?v=57.00', 'Das Phase-52-Stylesheet bleibt fachlich versioniert und erhält die neue Releasekennung.');
includes(appHtml, 'src/main.js?v=57.00', 'Das Main-Modul wird mit Phase-53-Kennung geladen.');
includes(mainSource, 'WorkspaceComponent.js?v=57.00', 'Der Workspace wird cache-sicher mit Phase 53 geladen.');
