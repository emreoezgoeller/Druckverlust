...
includes(versionSource, "APP_VERSION = '2.8.0'", 'App-Version steht auf 2.8.0.');
includes(versionSource, "APP_RELEASE = '53.00'", 'App-Release steht auf Phase 53.00.');
equal(packageJson.version, '2.8.0', 'package.json steht auf Version 2.8.0.');
equal(release.version, '2.8.0', 'release.json steht auf Version 2.8.0.');
equal(release.phase, '53.00', 'release.json steht auf Phase 53.00.');
check(Number(release.quality?.reportCompletionChecks) > 0, 'release.json dokumentiert die Phase-53-Prüfungen.');
includes(appHtml, 'phase52_00.css?v=52.00&release=53.00', 'Das Phase-52-Stylesheet bleibt fachlich versioniert und erhält die neue Releasekennung.');
includes(appHtml, 'src/main.js?v=53.00&release=53.00', 'Das Main-Modul wird mit Phase-53-Kennung geladen.');
includes(mainSource, 'WorkspaceComponent.js?v=53.00&release=53.00', 'Der Workspace wird cache-sicher mit Phase 53 geladen.');
includes(roadmap, 'Phase 53.00 – PDF- und Berichtsabschluss – abgeschlossen', 'Die Roadmap markiert Phase 53 als abgeschlossen.');
includes(roadmap, 'Phase 54.00', 'Die Roadmap nennt Phase 54 als nächsten Schritt.');
includes(changelog, '## 2.8.0 – Phase 53.00', 'Der Changelog enthält den Phase-53-Eintrag.');
includes(releaseNotes, 'Version 2.8.0', 'Die Release Notes nennen Version 2.8.0.');
includes(releaseNotes, 'Phase 53.00', 'Die Release Notes nennen Phase 53.00.');
